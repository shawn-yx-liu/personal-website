...
export default function Hero() {
    return (
        <div className="hero">
            <img className="hero-image" src="./assets/images/portrait_headshot.png" />
            ...
            <div className="hero-text">
                ...
                <div className="hero-location">
                    <img alt="Headshot of Shawn" className="hero-location-icon" src="../assets/icons/location.svg" />
                    <p>Palo Alto, California</p>
                </div>
                <div className="hero-socials">
                    <a href="https://github.com/shawn8913" target="_blank">
                        <img className="hero-social-icon" src="../assets/icons/github.svg" />
                    </a>
                    <a href="https://www.linkedin.com/in/shawn-liu-bbaba2158/" target="_blank">
                        <img className="hero-social-icon" src="../assets/icons/linkedin.svg" />
                    </a>
                </div>
            </div>
        </div>
